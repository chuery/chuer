...
<div style="max-width: 700px; margin-bottom: 2rem;">
  <h3 style="margin-bottom: 1rem;">Recently</h3>
  <ul style="margin: 0; padding-left: 1.5rem;">
    <li style="margin-bottom: 0.5rem;">Featured by Doctor Alvin Roth on his <a href="https://marketdesigner.blogspot.com/2025/05/ariel-rubinstein-and-coffee-culture.html" target="_blank">Market Design Blog</a></li>
    <li style="margin-bottom: 0.5rem;">Built a geodesic dome for my birthday</li>
  </ul>
</div>
</div>
